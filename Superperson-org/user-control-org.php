...
<head>
    ...
    <link rel="stylesheet" href="../css/user-control-org.css">
</head>
...
<body>
    ...
    <div class="tab-content" id="nav-tabContent">
            ...
            <div class="d-flex content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="calendar-org.php">Календарь</a></li>
                ...
                <div class="collaps">
                    ...
                    <div class="d-flex flex-row" id="title-date">
                        ...
                        <div class="d-flex" id="date-img">
                            <img src="../img/Polygon 12.svg" alt="">
                            <h1>20 мая 2023г.</h1>
                        </div>
                    </div>
        ...
        <!-- контроль, основная часть в папке control_emc.php -->
